...
def generate_pdf_report(case_data: Dict[str, Any], filepath: str):
    ...
    elements.append(Paragraph("Court-Admissible Electronic Mail Telemetry, Chain-of-Custody & Threat Assessment", subtitle_style))
    ...
    disclaimer = (
        "<b>LEGAL & EVIDENCE INTEGRITY ATTESTATION:</b> This document constitutes machine-generated "
        "forensic evidence compiled under RFC 5322/2822 parsing standards. SHA-256 evidence digests "
        "are cryptographically verifiable against original digital media. Generated by EMAILSHIELD INDIA."
    )
